...
';      // Enter your HTML Meaasge here
//    $to = $email;
//    $subject = "Your online seva booking in successful";
//
...
$_POST["email"] = 'chawandesaahil600@gmail.com';
$_POST["sub"] = 'Welcome Mail';
require "php-mailer/PHPMailerAutoload.php";
$mail = new PHPMailer;
//    $mail->SMTPDebug = 3;
$mail->isSMTP();                                      // Set mailer to use SMTP
$mail->Host = 'cp-32.webhostbox.net';  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'ack@afitness.in';                 // SMTP username
$mail->Password = 'ack@123';                           // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to

$mail->setFrom('ack@afitness.in', 'Online Exam');
...
if (!$mail->send()) {
    echo 'Mailer Error: ' . ' Not sent ' . $mail->ErrorInfo;
} else {
    echo 'success';
}
?>